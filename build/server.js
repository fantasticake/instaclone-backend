...
var serverCleanup = (0, ws_2.useServer)({
    ...
    onConnect: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(connectionParams === null || connectionParams === void 0 ? void 0 : connectionParams.token))
                            return [2 /*return*/, false];
                        if (!process.env.SECRET_KEY) return [3 /*break*/, 2];
                        token = ((_b = connectionParams.token) === null || _b === void 0 ? void 0 : _b._W) || connectionParams.token;
    ...
    context: function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!((connectionParams === null || connectionParams === void 0 ? void 0 : connectionParams.token) && process.env.SECRET_KEY)) return [3 /*break*/, 2];
                        token = ((_b = connectionParams.token) === null || _b === void 0 ? void 0 : _b._W) || connectionParams.token;
                        decoded = jwt.verify(token, process.env.SECRET_KEY);
                        if (!(typeof decoded == "object")) return [3 /*break*/, 2];
                        return [4 /*yield*/, prisma_1["default"].user.findUnique({
                    ...
                    case 1:
                        user = _c.sent();
                        return [2 /*return*/, { loggedInUser: user }];
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!(req &&
                            ...
                            process.env.SECRET_KEY)) return [3 /*break*/, 2];
